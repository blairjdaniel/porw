import os
from Scripts.image_hash import extract_image_urls_from_ipfs_metadata, hash_ipfs_images, has_specific_desired_traits
from Scripts.get_profile_image_hash import get_banner_image_phash  # You need to implement this
